...
//if user is deleted by the admin he shouldnt be allowed in the system
$off = 'No';
if($row['online']==$off){
  $_SESSION['offline'] = "<div class='alert alert-danger'>
<button class='close' data-dismiss='alert'>&times;</button>
<strong>Sorry!</strong>  You are no longer a user of this website.
</div>";
...
<body>
    ...
    <div class="row" style="background-color: white">
      <div class="col-md-10 col-md-offset-1">
        ...
        }else{//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxverified if statementxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
              $x = 0;
              $respstack = $con->query("SELECT * FROM tbl_stacks ORDER BY id DESC");
              while($rowStack=$respstack->fetch_array()){
                $x++;
                ...
                <h4>
                  &nbsp&nbsp&nbsp<?php echo $num;?>
                    ...
                    <?php
                     $pending = "pending";
                     if($rowStack['finalDate']==$pending){ ?>
                       <span class="pull-right text-muted" style="background-color:blue">&nbsp&nbsp&nbsp&nbsp
                       <span class="fa fa-unlock" style="color:white"> Open</span>&nbsp&nbsp
                       <a href="?view=<?php echo $rowStack['stackNumber']?>" class="fa fa-info-circle" style="color:white"> More...</a>&nbsp&nbsp&nbsp
                       </span>
                      <?php
                       ...
                       ?>
                    <span class="pull-right text-muted" style="background-color:red">&nbsp&nbsp&nbsp&nbsp
                       <span class="fa fa-lock"style="color:white"> Closed</span>&nbsp&nbsp
                       <a href="?view=<?php echo $rowStack['stackNumber']?>" class="fa fa-info-circle" style="color:white"> More...</a>&nbsp&nbsp&nbsp
                    </span>
                       <?php

            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-calendar"></i><span><strong>Events</strong></span></a>
                     <ul class="dropdown-menu">
                        <li><a href="#"><strong>Event1</strong></a></li>
                        <li><a href="#"><strong>Event2</strong></a></li>
                        <li><a href="#"><strong>Event3</strong></a></li>
                     </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-globe"></i><span><strong>English</strong></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#"><span><i class="flags us"></i><span><strong>English</strong></span></span></a></li>
                        <li><a href="#"><span><i class="flags newzland"></i><span><strong>Newzland</strong></span></span></a></li>
                    </ul>
                </li>
                <li class="dropdown">
                   
                    
                      <li><a href="signup.php"><span class="glyphicon glyphicon-log-in"></span><strong>Signup</strong></a></li>

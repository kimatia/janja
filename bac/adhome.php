...
<a href="index.php" class="navbar-brand"><strong>Janja</strong></a>
        ...
        <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#"><i class="fa fa-user"></i><span>&nbsp; <strong><?php echo "Hello Admin ".$row['userName']; ?></strong></span>
                    </a>
                    </li>
  ...
  <div class="clockdate-wrapper">
    ...
    <div id="date"></div>
        ...
        <div class="well" style="position: fixed; width:24%"> 
          ...
          <div class="col-md-6">
          <div class="row">
          <div class="welll" style="position: relative;"> 
             <?php
    if(isset($errMSG)){
            ?>
...
<form method="post"  enctype="multipart/form-data" class="form-horizontal">
        ...
        <textarea class="form-control" type="text" name="user_content" id="user_content" placeholder="Enter chat" value="<?php echo $usercontent; ?>"></textarea>
